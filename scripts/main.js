...
function openModal(element) {
    ...
    if (data) {
        ...
        console.log("this is tech_list: ", tech_list);
        ...
        document.body.classList.add("modal-open"); // keep body page from scrolling
    }
}
